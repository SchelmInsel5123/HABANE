    ...
    <div ref={pageRef} className="product-detail">
      ...
      <section className="pd__hero container">
        ...
        <div className="pd__info">
          ...
          <div className="pd__newsletter-cta">
            <button
            ...
            <p className="pd__newsletter-hint">
              Erfahre als Erster, wann verfügbar
            </p>
          </div>
      ...
      <section className="pd__cta section">
        <div className="container" style={{ textAlign: 'center' }}>
          <h2 className="headline-lg">Interessiert an <span className="gold-text">{product.name}</span>?</h2>
          <p className="body-lg" style={{ maxWidth: '480px', margin: '16px auto 32px' }}>
            Erfahre als Erster vom Launch. Melde dich für exklusive Updates an.
          </p>
          <button
            onClick={handleNewsletterClick}
            className="btn btn-primary"
            style={{ padding: '18px 48px', fontSize: '1.05rem' }}
          >
            Zum Newsletter
            <svg className="btn-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
